...
func (mMemberInfo *MemberInfo) ExceptionsAttribute() *ExceptionsAttribute {
	for _, attrInfo := range mMemberInfo.attributes {
		switch attrInfo.(type) {
...
func (mMemberInfo *MemberInfo) RuntimeVisibleAnnotationsAttributeData() []byte {
	return mMemberInfo.getUnparsedAttributeData("RuntimeVisibleAnnotations")
}
func (mMemberInfo *MemberInfo) RuntimeVisibleParameterAnnotationsAttributeData() []byte {
	return mMemberInfo.getUnparsedAttributeData("RuntimeVisibleParameterAnnotationsAttribute")
}
func (mMemberInfo *MemberInfo) AnnotationDefaultAttributeData() []byte {
	return mMemberInfo.getUnparsedAttributeData("AnnotationDefault")
}

func (mMemberInfo *MemberInfo) getUnparsedAttributeData(name string) []byte {
	for _, attrInfo := range mMemberInfo.attributes {
		switch attrInfo.(type) {
